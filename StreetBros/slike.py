...
player1_cross_desno = pygame.transform.scale(pygame.image.load("player1\cross\player1_cross_desno.png"), (350, 350))
player1_cross_levo = pygame.transform.scale(pygame.image.load("player1\cross\player1_cross_levo.png"), (350, 350))
